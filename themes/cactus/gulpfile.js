...
gulp.task("lib:mesloFont", function () {
    return download(
        "https://github.com/andreberg/Meslo-Font/blob/master/dist/v1.2/Meslo%20LG%20v1.2.zip?raw=true"
    )
        .pipe(
            decompress({
...
gulp.task("lib:vazirFont", function () {
    return gulp
        .src(["node_modules/vazir-font/dist/*"], { base: "node_modules/vazir-font/dist" })
...
gulp.task("lint:js", function () {
    return gulp.src(["./source/js/**/*.js"]).pipe(jshint()).pipe(jshint.reporter(stylish));
});

gulp.task("lint:stylus", function () {
    return gulp
        .src(["./source/css/*.styl", "./source/css/_partial/*.styl", "./source/css/_colors/*.styl"])
        .pipe(
            stylint({
                config: ".stylintrc",
                reporter: {
